...
finder(["mercedes","jeep", "lexus","mercedes"], "mercedes");
...
function whoAmI(person) {
  if(!person.name){           // remember that person is just parameter which is the object, can call it anything 
    return 'has amnesia';
  }
  return person.name;
 }
